...
LUA_SHA1 = get_hash(os.path.join(CWD, 'kakaotv.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'video':
                wget_args.extend(['--warc-header', 'kakaotv-video: '+item_value])
                wget_args.append('https://tv.kakao.com/v/'+item_value)
            elif item_type == 'playlist':
                wget_args.extend(['--warc-header', 'kakaotv-playlist: '+item_value])
                wget_args.append('https://tv.kakao.com/api/v1/ft/playlists/'+item_value)
            elif item_type == 'channel':
                wget_args.extend(['--warc-header', 'kakaotv-channel: '+item_value])
                wget_args.append('https://tv.kakao.com/channel/'+item_value+'/info')
            elif item_type == 'asset':
                url = 'https://' + item_value
                wget_args.extend(['--warc-header', 'kakaotv-asset: '+url])
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/c/cc/KakaoTV-icon.png" height="50px" title=""/>
        <h2>KakaoTV <span class="links"><a href="https://tv.kakao.com/">Website</a> &middot; <a href="https://tracker.archiveteam.org/kakaotv/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Kakao_TV">Wiki</a></span></h2>
        <p>Archiving KakaoTV videos, playlists, channels, and assets.</p>
    '''
)
